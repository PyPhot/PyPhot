...
from pyphot import __version__ #, __last_updated__


# Alphabetical list of developers
developers = ['Feige Wang', 'Your Name']


class PyquasarError(Exception):
    pass
...
#        self._last_updated = __last_updated__
        ...
        # sciexp and pyphot_file instead of having them kept within the
        # object itself...
        self.sciexp = None
        self.pyphot_file = None
    ...
    def _initialize_log_file(self, log=None):
        ...
        self._log.write("------------------------------------------------------\n\n")
#        self._log.write("pyphot was last updated {0:s}\n".format(self._last_updated))
        self._log.write("This log was generated with version {0:s} of pyphot\n\n".format(
                                                                                    self._version))
